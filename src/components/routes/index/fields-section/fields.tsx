...
const items = [
    ...
    },
    {
        ...
        text: "Next.js is a JavaScript framework for building efficient and accessible websites and applications. It is a framework for server-rendered applications and is optimized for the web. It is based on React and uses React Router for page navigation.",
        color: "indigo-900",
    },
    {
        title: "Scss",
